...
public class productsTable {
    ...
    private JComboBox ProductTypecb;

    private Object[] proType = new Object[]{"Clock", "Watch"};
    ...
    public void productsTableInitiate() {
        ...
        searchField.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Vector<productDTO> productList = productBUS.searchProduct(input);
                ...
                for (int i = 0; i < productList.size(); i++) {
                    ...
                    row.add(productList.get(i).getProviderID());
...
public void addPanel() {
    ...
    ProductTypecb = new JComboBox(proType);
    ...
    ProductTypecb.setPreferredSize(new Dimension(150, 20));
    ...
    gbc.gridy = 5;
    gbc.anchor = GridBagConstraints.EAST;
    currentAddDialog.add(ProductTypecb, gbc);
    ...
    addMore.addActionListener(new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                product.setProductType(ProductTypecb.getSelectedItem().toString());
    ...
    public void updatePanel() {
        ...
        gbc.gridwidth = 1;
        gbc.anchor = GridBagConstraints.WEST;
        updateDialog.add(ProductTypecb, gbc);
