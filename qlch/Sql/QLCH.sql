...
(N'Nguyễn Văn C', 'QL', 8000000, '1234567890'),
(N'Nguyễn Văn D', 'QL', 7000000, '2345678901');

-- Thêm nhà cung cấp
insert into Providers(ProviderName, ProviderPhone) values 
(N'Công ty Casio', '0123456789'),
(N'Công ty Citizen', '0123456788'),
(N'Công ty Orient', '0123456787'),
(N'Công ty Rolex', '0123456786');
